...
class ViewController: UIViewController {
        ...
        didSet {
            ...
            guard isRootController else {
                guard
                    ...
                    parentController.isRootController
                else { return }
    ...
    private func initialSetup() {
        ...
        self.navigationItem.rightBarButtonItems = [UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(setupAlertController)), UIBarButtonItem(image: UIImage(systemName: "trash"), landscapeImagePhone: nil, style: .plain, target: self, action: #selector(deleteAllTasks))]
